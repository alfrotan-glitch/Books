...
Run before build whenever a chapter's References section changes."""
import glob, re
...
out = ["# ضمیمهٔ ۹۵ — منابع کتاب به ترتیب فصل", "",
       ...
       "منابعی که در متن فصل با «خوانده نشد» نشانی شده‌اند، در فهرست قرض علمی (`release/open-scientific-debt.md`) ثبت‌اند. "
