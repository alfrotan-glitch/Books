...
- **Axial spondyloarthritis** (شامل Ankylosing spondylitis)، **Psoriatic arthritis**، **Reactive arthritis**، و ارتریت همراه IBD (فصل ۳۳).
- **ویژگی‌های مشترک:**
...
**کمر درد اکثراً مکانیکی است** (فصل ۷۱). اما این سرنخ‌ها **کمر درد التهابی** را نشان می‌دهند:
