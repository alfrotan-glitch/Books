...
> **بخش نهم — روماتولوژی** · *Currentness audit: نقرس — **ACR 2020** (FitzGerald JD et al., Arthritis Care Res 2020;72:744–760)؛ خلاصه و متن جزئی از ResearchGate و Medscape (سپتمبر ۲۰۲۶) خوانده شد. EULAR 2016 برای Colchicine ۰.۵ mg. OA — اصول **ACR/Arthritis Foundation 2019** (Kolasinski SL et al.)؛ متن اصلی خوانده نشد → SD-60.*
...
- **بی‌بی گل** ۶۵ ساله را از فصل ۶۶ می‌شناسیم: سال‌ها درد زانو که با راه رفتن و زینه بدتر می‌شود. «کسی گفته هر روز Diclofenac بخورم و آمپول Dexamethasone بزنم.»
...
- **عوامل همراه:** چاقی، فشار بلند، دیابت، CKD، و مرض قلبی. **نقرس نشانهٔ خطر قلبی–متابولیک است** (فصل ۹).
...
- ⚠️ **ارتریت سپتیک را رد کن** (فصل ۷۰). مفصل داغ یک‌گانه با تب → Aspiration. **انتان و کرستال می‌توانند با هم باشند.**
...
| **NSAID** | دوز کامل، کوتاه‌مدت | قرحهٔ هضمی (Peptic ulcer)، CKD، عدم کفایهٔ قلب، ضد انعقاد (فصل ۲۵، ۴۲) |
...
- **درد مکانیکی:** با کار بدتر، با استراحت بهتر؛ **سختی صبحگاهی کوتاه** (فصل ۶۶)؛ Crepitus.
...
- **RF، ANA و «پنل روماتیزمی» لازم نیست** (فصل ۶۶).
