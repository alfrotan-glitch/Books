...
- **B (تنفس):** تنفس سریع، **خس‌خس**، خستگی، کبودی، SpO₂ کمتر از ۹۲ فیصد؛
- **C (دوران):** رنگ پریده، عرق سرد، **فشار پایین**، غش، خواب‌آلودگی.

**علایم پوستی** (کهیر، سرخی، پندیدگی) اکثراً هست، اما **تا ۲۰ فیصد نیست** (RCUK 2021 — بیشتر از ۸۰ فیصد علایم پوستی دارند). **نبود کهیر Anaphylaxis را رد نمی‌کند.**
...
- **نظارت پس از رفع کامل علایم** (RCUK 2021؛ عکس‌العمل دوفازی ممکن است):
  - **۲ ساعت** (رخصت سریع) فقط اگر: یک دوز عضلی در ۳۰ دقیقهٔ اول، پاسخ خوب در ۵–۱۰ دقیقه، رفع کامل علایم، مریض قلم خودزرق Adrenaline دارد و طرز استعمال را می‌داند، و مراقب در خانه هست.
  - **حد اقل ۶ ساعت:** اگر **دو دوز** عضلی لازم شد، یا سابقهٔ عکس‌العمل دوفازی دارد.
  - **حد اقل ۱۲ ساعت:** بیشتر از دو دوز؛ آسمای شدید یا مشکل تنفسی شدید؛ جذب ادامه‌دار (دوای آهسته‌رهش)؛ رسیدن در شب؛ یا **دسترسی دشوار به عاجل** — ⚠️ در بسیاری ولسؤالی‌های افغانستان این شرط آخر صدق می‌کند.
...
### ۴. تخمین وسعت (TBSA)
- **قاعدهٔ ۹ (Rule of nines)** در کاهلان: سر ۹ فیصد، هر بازو ۹ فیصد، صدر و بطن ۱۸ فیصد، پشت ۱۸ فیصد، هر پا ۱۸ فیصد، ناحیهٔ تناسلی ۱ فیصد.
- **کف دست مریض (با انگشتان) نزدیک به ۱ فیصد.**
- **فقط سوختگی نسبی و کامل (Partial و Full thickness)** را بشمار؛ **سرخی ساده (Superficial) را نه**.
- **دام:** تخمین زیاد در شروع، و مایع زیاد.

### ۵. مایع (ABA 2023)
- **کاهلان و اطفال با سوختگی بیشتر از ۲۰ فیصد TBSA** → احیای رسمی با مایع.
...
- **سوختگی نسبی و کامل:** صورت و گردن ۴.۵ فیصد + صدر ۹ فیصد + هر دو بازو ۱۸ فیصد = ۳۱.۵ ≈ **۳۲ فیصد**.
- **مایع (ABA، شروع با ۲):** ۲ × ۶۰ × ۳۲ = **۳۸۴۰ mL** در ۲۴ ساعت → **۱۹۲۰ mL در ۸ ساعت اول** (یعنی ۲۴۰ mL/ساعت)، سپس تنظیم مطابق **ادرار ۳۰ mL/ساعت یا بیشتر** (۰.۵ × ۶۰).
- **COHb ۱۲ فیصد** → اکسیجن ۱۰۰ فیصد ادامه یافت.
...
6. **شوک در ساعت اول سوختگی = خونریزی دیگر را بجوی.**
