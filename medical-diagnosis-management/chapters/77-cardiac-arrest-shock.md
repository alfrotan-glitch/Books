...
- **جلوگیری از تب و کنترول حرارت** در مریضی که بیدار نیست؛ علت را تداوی کن. ERC–ESICM 2025: در مریضی که پس از ROSC بی‌هوش مانده، حرارت را **۳۷٫۵ °C یا کمتر** نگهدار، برای **۳۶ تا ۷۲ ساعت**؛ مریضی که خودش سرد (۳۲–۳۶ °C) است را **فعالانه گرم نکن**؛ مایع سرد زیاد وریدی پیش از شفاخانه را **به‌طور روتین نده**.
...
**علایم Hypoperfusion:** پوست سرد و مرطوب (یا گرم در اوایل سپسیس (Sepsis))، **Capillary refill** بیشتر از ۳ ثانیه، **گیچی**، **ادرار کم**، و **Lactate بلند**.
...
| **Distributive** | **سپسیس** (فصل ۶۷)، **Anaphylaxis** (فصل ۸۱)، Neurogenic، Adrenal crisis (فصل ۵۰) | پایین یا عادی | **گرم** (اوایل) | مایع + Noradrenaline؛ **Adrenaline در Anaphylaxis**؛ Hydrocortisone در Adrenal |
