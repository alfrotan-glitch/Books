...
## ۱. ضعف حاد: جای ضایعه کجاست؟ (فصل ۵۳)
| جای ضایعه | سرنخ |
|---|---|
...
| **متابولیک** | **Hypokalaemia** (فصل ۴۲)، Hypophosphataemia |
...
**Compound:** زن حامله با MG و **Eclampsia** — Magnesium خطرناک است (فصل ۸۳). **پیش از هر نسخه در مریض MG، این جدول را ببین.**
