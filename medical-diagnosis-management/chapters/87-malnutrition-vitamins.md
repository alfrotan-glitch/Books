...
|---|---|---|---|
| **Thiamine (B1)** | گرسنگی، **الکول**، استفراغ حاملگی، **Refeeding**، غذای فقط برنج سفید | **Wernicke:** گیچی + **اختلال حرکت چشم** + بی‌ثباتی راه رفتن (اکثراً هر سه نیست)؛ **Beriberi:** عدم کفایهٔ قلب با برون‌ده بلند، Neuropathy | **Wernicke = عاجل → Thiamine ۲۰۰ mg سه بار در روز، ترجیحاً وریدی** (رقیق در ۱۰۰ mL، در ۳۰ دقیقه)، **پیش از هر Glucose**؛ تا وقتی بهبود ادامه دارد (EFNS 2010). در الکولی‌ها بعضی منابع ۵۰۰ mg سه بار در روز را توصیه کرده‌اند (همان رهنمود). فمی مؤثر نیست. منتظر امکانات احیا نمان. |
...
3. **Thiamine وریدی** (با اسهال شدید، جذب فمی مطمئن نیست) پیش از هر Glucose؛ ویتامین B مرکب.
...
3. کالوری شروع در خطر بسیار بلند؟ ← حد اعظمی ۱۰ kcal/kg/روز.
