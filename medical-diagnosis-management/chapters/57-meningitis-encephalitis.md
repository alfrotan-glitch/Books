...
| **۶۰ سال یا بیشتر، یا ضعف معافیت** (الکول، حاملگی، مرض کبدی، دیابت) → برای **Listeria** | **Ceftriaxone ۲ g هر ۱۲ ساعت + Amoxicillin (یا Ampicillin) ۲ g وریدی هر ۴ ساعت** |
...
| ۵:۳۰ | CT لازم نبود (گیچی خفیف، بدون علایم موضعی) → **LP:** کدر، ۲۲۰۰ حجره (۹۰ فیصد Neutrophil)، Glucose بسیار کم |
