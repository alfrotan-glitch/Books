...
- **حاجی رحیم** ۷۰ ساله، با **تب ۳۹ درجه، لرزه و درد پهلو** آمده؛ کتتر ادرار ندارد اما پروستات بزرگ دارد. فشار او پایین است.
...
2. **ساده یا اختلاطی (Uncomplicated / Complicated)؟** مریض سالم یا مریضی با ساختمان/وظیفهٔ غیرنورمال، حاملگی، مرد، کتتر، ایمنی ضعیف؟
3. **سپسیس دارد یا نه؟**

و یک قاعدهٔ طلایی: **باکتری در ادرار بدون علایم ≠ انتان** (Asymptomatic bacteriuria)؛ اکثراً تداوی نمی‌خواهد.

💡 **تشبیه:** مجاری ادرار یک **جوی آب یک‌طرفه** است. جریان ادرار باکتری‌ها را بیرون می‌شوید. هر چیز که جریان را کند کند (انسداد، سنگ، پروستات، کتتر، حاملگی) یا راه را کوتاه کند (احلیل کوتاه زن)، به باکتری فرصت بالا رفتن می‌دهد.
...
| **UTI اختلاطی (Complicated)** | UTI با خطر بیشتر ناکامی تداوی: ناهنجاری ساختمانی یا وظیفوی، انسداد، سنگ، کتتر، ایمنی ضعیف، مرد، حاملگی؛ IDSA 2025 Pyelonephritis را هم در cUTI شامل می‌کند |
...
**دفاع‌ها:** جریان ادرار، تخلیهٔ کامل مثانه، مخاط سالم. **شکست دفاع‌ها:** انسداد، باقی‌ماندهٔ ادرار (پروستات، مثانهٔ عصبی)، کتتر (Biofilm)، سنگ، دیابت، حاملگی (شل شدن Ureter با Progesterone).
...
| Pseudomonas، ارگانیزم‌های مقاوم (**ESBL**) | شفاخانه، کتتر، استفادهٔ قبلی انتی‌بیوتیک |

**خطر:** مقاربت، دیابت، حاملگی، یائسگی، انسداد، کتتر، **استفادهٔ قبلی انتی‌بیوتیک** (خطر مقاومت).

⚠️ **مقاومت در افغانستان:** مصرف گستردهٔ انتی‌بیوتیک بدون نسخه، مقاومت را بلند برده است. **هر جا ممکن است، کلچر ادرار بفرست** و انتخاب را با نتایج کلچر و داده‌های مقاومت محلی تنظیم کن (NICE NG109 1.4.1).
...
## معاینه
- علایم حیاتی — **سپسیس** را رد کن (qSOFA/NEWS2؛ فصل ۱؛ اهتمام سپسیس → فصل ۶۷).
...
| درد پهلو + تب + مسن | Pyelonephritis، **ابسهٔ گرده**، انسداد انتانی |
...
| **کلچر ادرار (Midstream)** — **پیش از انتی‌بیوتیک** | **حاملگی، مرد، Pyelonephritis، UTI اختلاطی یا عودکننده، ناکامی تداوی** (NICE NG109 1.1.6؛ NG111 1.1.2) |
| CBC، Creatinine، CRP، **کلچر خون**، Lactate | Pyelonephritis شدید یا سپسیس |
| **Ultrasound** | شک به انسداد، سنگ، ابسه، پاسخ ندادن به تداوی |
| CT | ابسه، Emphysematous pyelonephritis (دیابتی)، سنگ |
...
## تداوی
### ۱۰.۱ عاجل — Urosepsis
- **Sepsis bundle** (فصل ۶۷): کلچر خون و ادرار، مایع، انتی‌بیوتیک وریدی **زود**.
- **IDSA 2025 (cUTI با سپسیس):** انتخاب اولیه از میان **سفالوسپورین‌های نسل سوم یا چهارم، Carbapenem، Piperacillin-tazobactam یا Fluoroquinolone** — نه دواهای جدید (ترکیب‌های جدید Beta-lactam و مهارکننده، Cefiderocol، Plazomicin) و نه Aminoglycosideهای قدیمی به‌عنوان انتخاب معمول (توصیهٔ مشروط). انتخاب با یک **ارزیابی چهارقدمه**: شدت مرض؛ خطر مقاومت (کلچرهای قبلی، مصرف قبلی انتی‌بیوتیک)؛ عوامل مریض (حساسیت، تداخلات)؛ و Antibiogram **محلی، تازه و مرتبط**.
...
- خطر مقاومت Trimethoprim **کمتر** است اگر در **۳ ماه گذشته** مصرف نشده باشد؛ **بیشتر** در مسن‌های مقیم مراکز مراقبت.
...
| **Ciprofloxacin** (**فقط اگر** بقیه مناسب نیستند) | **۵۰۰ mg دو بار در روز — ۷ روز**. ⚠️ **MHRA 2024:** Fluoroquinoloneها فقط وقتی تجویز شوند که دیگر انتی‌بیوتیک‌های معمول مناسب نیستند (خطر عوارض ناتوان‌کننده و طولانی: وتر، اعصاب، روان، Aorta) |
...
| **Amikacin** | **ابتدا ۱۵ mg/kg IV یک بار در روز (حد اعظمی ۱.۵ g در هر دوز)**؛ بعد بر پایهٔ سطح سیرومی (حد اعظمی ۱۵ g در هر کورس)؛ نظارت سطح و گرده |
...
- مدت از **اولین روز انتی‌بیوتیک مؤثر** حساب می‌شود.
- **استثناها (مدت فردی):** مرد با UTI تب‌دار و شک به **Prostatitis حاد** (شاید ۱۰–۱۴ روز)، کتتر، ابسه، انسداد کامل، ایمنی ضعیف، CKD — این گروه‌ها در تریال‌ها کم بودند.
- شواهد کوتاه‌مدت برای **Beta-lactam‌های فمی** محدودتر است و شاید **دوز بلندتر** لازم باشد.
...
Sepsis bundle، کلچر خون و ادرار، **Ultrasound** برای انسداد (پروستات)، کتتر مثانه اگر باقی‌ماندهٔ ادرار زیاد است. انتی‌بیوتیک وریدی مطابق §۱۰.۱ و Antibiogram محلی. پس از کلچر، **دوای هدفمند** (IDSA 2025). مرد تب‌دار با شک Prostatitis ← مدت فردی.
...
- **تخلیهٔ ابسهٔ** گرده یا اطراف گرده.
- برداشتن یا تعویض **کتتر** در CAUTI.
...
| اختلاط | نکته |
|---|---|
| **Urosepsis** و شوک | مرگ‌آور؛ مسن، دیابتی، انسداد |
| **ابسهٔ گرده/اطراف گرده** | تب دوامدار با وجود انتی‌بیوتیک ← CT |
...
- **Pyelonephritis که با تداوی بهتر نمی‌شود** ← تصویربرداری (انسداد، ابسه).
...
- ⚠️ **تب دوامدار با وجود انتی‌بیوتیک مناسب** — ابسه یا انسداد.
- ⚠️ **حامله با تب و درد پهلو** — بستری.
- ⚠️ **مرد با Retention و تب** — Prostatitis حاد یا ابسهٔ پروستات.
...
## کنار بستر
1. پیش از نوشتن انتی‌بیوتیک برای «UTI»، بپرس: **حامله؟ مرد؟ تب؟ کتتر؟**
