...
> اختصارات پراستعمال کتاب، به ترتیب الفبای انگلیسی. معنی هر اختصار در اولین استعمال در هر فصل هم آمده است. اختصاراتی که در دو معنی به کار رفته‌اند (مثلاً CO، SBP، AFP) با «مطابق متن» نشانی شده‌اند: معنی را از جمله بفهم.
...
| **AFB** | Acid-fast bacilli | باسیل اسیدفست |
| **AFP** | Acute flaccid paralysis / Alpha-fetoprotein | فلج شل حاد / الفا فیتوپروتین (مطابق متن) |
| **AIHA** | Autoimmune haemolytic anaemia | انمی همولیتیک خودایمن |
...
| **CXR** | Chest X-ray | اکسری صدر |
| **DAPT** | Dual antiplatelet therapy | تداوی دوگانهٔ ضد پلیت |
| **DIC** | Disseminated intravascular coagulation | انعقاد منتشر داخل عروقی |
| **DKA** | Diabetic ketoacidosis | کیتواسیدوز دیابتیک |
| **DMARD** | Disease-modifying antirheumatic drug | دوای تعدیل‌کنندهٔ مرض روماتیزمی |
| **DOAC** | Direct oral anticoagulant | ضد انعقاد فمی مستقیم |
| **DVT** | Deep vein thrombosis | ترومبوز ورید عمقی |
| **ECG** | Electrocardiogram | الکتروکاردیوگرام |
| **EEG** | Electroencephalogram | الکتروانسفالوگرام |
| **eGFR / GFR** | (Estimated) glomerular filtration rate | میزان فلتریشن کبیبه‌یی (تخمینی) |
| **ERCP** | Endoscopic retrograde cholangiopancreatography | اندوسکوپی مجاری صفراوی و پانکراس |
| **ESR** | Erythrocyte sedimentation rate | سرعت رسوب کریوات سرخ |
...
| **IVIg** | Intravenous immunoglobulin | ایمونوگلوبولین وریدی |
| **IVT** | Intravenous thrombolysis | حل لخته از راه ورید |
| **JVP** | Jugular venous pressure | فشار ورید وداجی |
| **LDH** | Lactate dehydrogenase | لاکتات دیهایدروجیناز |
| **LMWH** | Low-molecular-weight heparin | هیپارین با وزن مالیکولی کم |
| **LP** | Lumbar puncture | کشیدن مایع نخاع |
| **MDR / XDR** | Multidrug- / Extensively drug-resistant | مقاوم به چند دوا / مقاومت گسترده |
| **MG** | Myasthenia gravis | مایستینیا گراویس |
| **MI** | Myocardial infarction | انفارکت عضلهٔ قلب |
| **MRI** | Magnetic resonance imaging | تصویربرداری با رزونانس مقناطیسی |
| **MRSA** | Methicillin-resistant Staphylococcus aureus | ستافیلوکوک مقاوم به میتیسلین |
| **MUAC** | Mid-upper arm circumference | محیط وسط بازو |
| **NAC** | N-acetylcysteine | ان–استیل سیستئین |
| **NIHSS** | NIH Stroke Scale | مقیاس سکتهٔ NIH |
| **NIV** | Non-invasive ventilation | تهویهٔ غیرتهاجمی |
| **NSAID** | Non-steroidal anti-inflammatory drug | دوای ضد التهاب غیر ستیروئیدی |
| **NSTEMI / STEMI** | Non-ST- / ST-elevation myocardial infarction | انفارکت بدون / با بلندی قطعهٔ ST |
| **ORS** | Oral rehydration solution | محلول آب‌رسانی فمی |
| **PCI** | Percutaneous coronary intervention | مداخلهٔ اکلیلی از راه جلد |
| **PCR** | Polymerase chain reaction | تست PCR |
| **PE** | Pulmonary embolism | امبولی ریوی |
| **PEA** | Pulseless electrical activity | فعالیت برقی بدون نبض |
| **PPI** | Proton pump inhibitor | مهارکنندهٔ پمپ پروتون |
...
| **ENLS** | Emergency Neurological Life Support (Neurocritical Care Society) |
...
این ضمیمه تعریف اختصارات است و منبع جداگانه ندارد.
