...
- **عوامل تحریک حمله:**
  ...
  - کم‌آبی (Dehydration)، جراحی، و **شروع یا تغییر تداوی کاهش یوریک**.
...
- **تشخیص قطعی: کرستال‌های سوزنی با Birefringence منفی** در مایع مفصل زیر میکروسکوپ پولاریزه.
...
| دوا | دوز / نکته | احتیاط |
|---|---|---|
| **Colchicine** | ACR 2020 (دوز FDA): **۱.۲ mg، بعد ۰.۶ mg پس از یک ساعت**. جایی که تابلت ۰.۵ mg است (EULAR 2016): **۱ mg، بعد ۰.۵ mg پس از یک ساعت** | **تداخل** با Clarithromycin، Verapamil، Diltiazem، Ciclosporin (سمیت کشنده)؛ **CKD** → کم کن یا نده؛ اسهال |
...
- درد OA که در شب و هنگام استراحت هم شدید است (انتان، تومور، یا Avascular necrosis را در نظر بگیر).

## ⏱️ مرور ۶۰ ثانیه
1. تشخیص قطعی نقرس؟ ← کرستال سوزنی با Birefringence منفی در مایع مفصل.
2. دوز Colchicine در حمله (ACR 2020)؟ ← ۱.۲ mg، بعد ۰.۶ mg پس از یک ساعت (با تابلت ۰.۵: ۱ mg بعد ۰.۵ mg).
