...
- اسهال مزمن و کاهش وزن بدون علت (فصل ۲۹، ۳۰)؛
...
- **Lymphoma** (فصل ۶۵)، Kaposi sarcoma؛
- **Cytopenia** بدون علت (فصل ۶۰، ۶۲)؛
- انتانات منتقله از راه جنسی، **HBV و HCV** (راه‌های انتقال مشترک، فصل ۳۱)؛
...
| **Cryptococcal antigen (CrAg)** | کمتر از ۱۰۰ (قوی)؛ کمتر از ۲۰۰ قابل بررسی | پیش از شروع ART؛ CrAg مثبت → **LP** برای رد مننژیت؛ بدون مننژیت → تداوی پیش‌گیرانهٔ Fluconazole |
| **بدون CrAg** | کمتر از ۱۰۰ | پروفیلاکسی Fluconazole |
| **Co-trimoxazole پروفیلاکسی** | طبق پروتوکول | *Pneumocystis*، Toxoplasma، و باکتری‌ها |
| **تداوی پیش‌گیرانهٔ TB (TB preventive treatment)** | پس از رد TB فعال | فصل ۱۹ |
