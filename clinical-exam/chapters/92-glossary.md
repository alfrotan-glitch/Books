...
| دری | English |
|------------------------------|------------------------------|
| آبله بزرگ (بولا) | bulla |
| آبله کوچک (وزیکول) | vesicle |
...
| پندیدگی دیسک بصری (پاپیل‌اذیما) | papilloedema |
...
| دفاع ارادی (گاردینگ ارادی) | voluntary guarding |
| دلیریم | delirium |
| دنباله بغلی ثدیه | axillary tail |
| دور وسط بازو | MUAC |
| دیمنشیا | dementia |
| ریزش لکه‌ای موی | alopecia areata |
| زبان‌گیر | tongue depressor |
...
| سندرم ذنب اسپ (کودا اکواینا) | cauda equina syndrome |
| سینه‌بغل | pneumonia |
| شاخص شاک | shock index |
| شتاب تشخیص | diagnosis momentum |
| شرسوف | epigastrium |
| شلی رحم (اتونی رحم) | uterine atony |
| صدای جریان (بروئی) | bruit |
| صدای گوش (تنیتوس) | tinnitus |
...
| کوری نیمه خارجی هر دو چشم (همی‌انوپیای بای‌تمپورال) | bitemporal hemianopia |
| کهیر (ویل) | wheal; urticaria |
| کیتواسیدوز دیابتی | diabetic ketoacidosis |
| کیست هایداتید | hydatid cyst; echinococcosis |
| گال | scabies |
| گره (نودول) | nodule |
| لرزش‌های کوچک عضله (فاسیکولیشن) | fasciculations |
| لرزش بال‌زدنی (استریکسیس) | asterixis |
| لرزش چشم (نیستاگموس) | nystagmus |
| لکه (ماکول) | macule |
...
| وترهای کلاهک چرخاننده (روتیتور کف) | rotator cuff |
| هذیان | delusion |
